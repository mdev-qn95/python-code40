# Basic Data Type: Multiplication/Exponent Table
...
print("\n\t" + str(num) + " ** 2 = " + str(round(num**2, 4)))
print("\n\t" + str(num) + " ** 3 = " + str(round(num**3, 4)))
print("\n\t" + str(num) + " ** 4 = " + str(round(num**4, 4)))
print("\n\t" + str(num) + " ** 5 = " + str(round(num**5, 4)))
print("\n\t" + str(num) + " ** 6 = " + str(round(num**6, 4)))
print("\n\t" + str(num) + " ** 7 = " + str(round(num**7, 4)))
print("\n\t" + str(num) + " ** 8 = " + str(round(num**8, 4)))
print("\n\t" + str(num) + " ** 9 = " + str(round(num**9, 4)))
